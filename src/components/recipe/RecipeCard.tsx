...
export function RecipeCard({ recipe, variant = 'normal' }: RecipeCardProps) {
  ...
  return (
    <motion.button
      ...
      className={`text-left bg-white rounded-[18px] shadow-card overflow-hidden ${
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="absolute top-[7px] right-[7px] w-[31px] h-[31px] rounded-full bg-white/95 flex items-center justify-center shadow-sm cursor-pointer"
